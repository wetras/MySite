...
<title>Информация о направлении подготовки "Информационная безопасность"</title>
<style type="text/css">
...
<style>
  ...
  background: #0046a3 linear-gradient(#379df1, #bf26d6);
}
...
<article class="columns-2">
    ...
    <adress> 
     ...
     <a class="a_footer" href="tel:83952405405"><font face="Arial" size="6"><br><br><br>8(3952)405-405</a>
